                ...
                <form onSubmit={handleSignup} className="space-y-6">
                    ...
                    {success && (
                        <motion.div
                            initial={{ opacity: 0, scale: 0.95 }}
                            animate={{ opacity: 1, scale: 1 }}
                            className="bg-green-50 text-green-600 p-4 rounded-xl text-sm font-bold text-center"
                        >
                            {success}
                        </motion.div>
                    )}
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-[#FDB913] text-white py-5 rounded-2xl font-bold text-lg shadow-xl shadow-[#FDB913]/20 hover:bg-[#e5a611] active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-70 mt-4"
                    >
                        {loading ? (
                            <>
                            ...
                            <>
                                Register Admin <UserPlus size={20} />
                            </>
                        )}
                    </button>
                    ...
                    <div className="text-center mt-4">
                        <button
                            ...
                            className="text-[#1A6B96] font-bold text-sm hover:underline"
                        >
                            Back to Login
                        </button>
                    </div>
